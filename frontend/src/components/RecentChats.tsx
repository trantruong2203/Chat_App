...
function RecentChats({ setIsAddFriendModalOpen, setIsAddGroupModalOpen, selectedMessage, lastMessages, setHandleLastMess, socket, onlineUsers }: RecentChatsProps): React.ReactElement {
    ...
    // ⚡ Bolt: Memoized lookups for performance
    // Create maps for users and groups, and a set for online users to avoid O(n) searches inside the map loop.
    // This improves rendering performance, especially with many chats or users.
    ...
    // ⚡ Bolt: Optimized lookup functions
    // These functions now use the memoized maps for O(1) lookups, greatly improving performance.
